...
INSERT INTO questions(id, content, partie_cours_id) VALUES
    ...
    (9, 'Les bases de données permettent-elles de d''analyser un grand nombre d''informations ?', 1),
    ...
    (14, 'Pourquoi n''y a-t-il pas d''attributs multi-valués dans un modèle relationnel?', 3),
    (15, 'Quelle est l''utilité de l''implantation de la thêta-jointure dans une base de donnée?', 4),
    ...
    (20, 'Quelle est la différence entre une entité et une relation?', 2),
